...
def main(config: str, min_accuracy: float):
    ...
    if deploy:
        ...
        continuous_deployment_pipeline(
            data_path="D:\customer\data\olist_customers_dataset.csv",
    ...
    # Check if the OS is Windows and print a message regarding daemon functionality
    if platform.system() == "Windows":
        print("Daemon functionality is currently not supported on Windows.")
